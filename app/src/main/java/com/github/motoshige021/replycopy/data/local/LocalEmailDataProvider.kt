package com.github.motoshige021.replycopy.data.local

import com.github.motoshige021.replycopy.data.Email
import com.github.motoshige021.replycopy.data.EmailAttachment
import com.github.motoshige021.replycopy.data.MailboxType
...
object LocalEmailDataProvider {
    private val threads = listOf(
        Email(
            id = 8L,
            sender = LocalAccountDataProvider.getContactAccountByUid(13L),
            recipients = listOf(LocalAccountDataProvider.getDefaultUserAccount()),
        ...
        Email(
            id = 6L,
            sender = LocalAccountDataProvider.getContactAccountByUid(10L),
            recipients = listOf(LocalAccountDataProvider.getDefaultUserAccount()),
        ...
        Email(
            id = 7L,
            sender = LocalAccountDataProvider.getContactAccountByUid(9L),
            recipients = listOf(LocalAccountDataProvider.getDefaultUserAccount()),
            subject = "Delivered",
        ...
        Email(
            id = 1L,
            sender = LocalAccountDataProvider.getContactAccountByUid(6L),
            recipients = listOf(LocalAccountDataProvider.getDefaultUserAccount()),
        ...
        Email(
            id = 2L,
            sender = LocalAccountDataProvider.getContactAccountByUid(5L),
            recipients = listOf(LocalAccountDataProvider.getDefaultUserAccount()),
    ...
    val allEmails = listOf(
        ...
        Email(
            2L,
            LocalAccountDataProvider.getContactAccountByUid(5L),
            listOf(LocalAccountDataProvider.getDefaultUserAccount()),
            "Bonjour from Paris",
        ...
        Email(
            3L,
            LocalAccountDataProvider.getContactAccountByUid(8L),
            listOf(LocalAccountDataProvider.getDefaultUserAccount()),
            "High school reunion?",
            """
                Hi friends,
        ...
        Email(
            id = 4L,
            sender = LocalAccountDataProvider.getContactAccountByUid(11L),
            recipients = listOf(
                LocalAccountDataProvider.getDefaultUserAccount(),
                LocalAccountDataProvider.getContactAccountByUid(8L),
                LocalAccountDataProvider.getContactAccountByUid(5L)
            ),
            subject = "Brazil trip",
