...
import com.github.motoshige021.replycopy.data.Account
import com.github.motoshige021.replycopy.R

object LocalAccountDataProvider { // objectで宣言するとシングルトンなクラスを生成する
    val allUserAccounts = listOf(
        Account(
            ...
            altEmail = "hikingfan@outside.com",
    ...
    fun isUserAccount(id: Long): Boolean = allUserAccounts.any{ it.uid == id }
